CREATE TABLE [dbo].[offlinx_ovrs_revenue_staging] (
    ...
    INDEX [ovrs_rev_staging1] NONCLUSTERED ([offlinx_site_id], [from_date], [to_date], [offlinx_channel_type_code], [offlinx_channel_source_code], [offlinx_channel_network_id], [desktop], [mobile], [tablet])
)
