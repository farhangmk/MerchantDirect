...
CREATE PROCEDURE summarize_offlinx_visit_revenue_new @FromDate DATE, @ToDate DATE
AS
...
+ CONVERT(VARCHAR, CAST( ROUND( SUM( IIF(at.electronic_commerce_indicator IN('5','6','7','8','9'), 1, otvc.factor) / total_attributions ) , 0) AS INTEGER) ) + '","'
